...
const people = [
	  ...
	  },
	  {
		...
		imageUrl: "https://i.imgur.com/4ySdkyH.png",
		twitterUrl: '#',
		discordUrl: '#',
	  },
	  {
		...
		imageUrl: "https://res.cloudinary.com/dbshcjrt3/image/upload/w_1480,h_986,c_fill,g_auto,q_auto/wikifactory-prod-uploads/22873/image-2675a.png",
		twitterUrl: '#',
		discordUrl: '#',
	  },
	  {
		name: 'Keightie',
		role: 'XR Development',
		imageUrl: "https://i.pinimg.com/564x/fa/ac/80/faac8092d7975c1b2577325e9e7b0828.jpg",
		twitterUrl: '#',
		discordUrl: '#',
	  },
	  {
		...
		imageUrl: "https://upload.wikimedia.org/wikipedia/commons/7/79/Jai_at_Nadigar_Sangam_Election.jpg",
		twitterUrl: '#',
		discordUrl: '#',
	  },
	  {
		...
		imageUrl: "https://progameguides.com/wp-content/uploads/2018/05/fortnite-outfit-zoey-816x853.jpg",
		twitterUrl: '#',
		discordUrl: '#',
	  }
]
